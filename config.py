...
OWNER_ID = int(getenv("OWNER_ID", 8142914021))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/+NPO0XrGK3kM1Mzc9")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/AnneBella_gc")
